...
func (suite *EventDispatcherTestSuite) SetupTest() {
	...
	suite.event = TestEvent{Name: "test1", Payload: "test"}
...
func (suite *EventDispatcherTestSuite) TestEventDispatcher_Dispatch() {
	//dispatchedEventCh := make(chan EventHandlerInterface)
	eh := &MockHandler{}
	...
	//suite.eventDispatcher.Dispatch(&suite.event, dispatchedEventCh)

	// for ehd := range dispatchedEventCh {
	// 	suite.Equal(&suite.handler2, ehd)
	// }
